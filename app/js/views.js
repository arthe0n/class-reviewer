...
(function () {
  ...
  function viewDashboard(root) {
    ...
    var termText = 'reviewapp v1.0.10 — ' + (cert ? cert.name + ' · ' : '') + compactNumber(counts.questions) + ' questions · ' +
  ...
  function buildMarkdownReport(certId) {
    ...
    L.push('---');
    L.push('');
    L.push('_Generated by ReviewApp v1.0.10 — offline study analytics._');
    L.push('');
  ...
  function viewSettings(root) {
    ...
    about.appendChild(el('p', { text: 'ReviewApp v1.0.10 — offline study hub for CompTIA Linux+ and Network+.' }));
