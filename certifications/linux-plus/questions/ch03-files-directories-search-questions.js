...
type: "mcq",
options: ["Moves to the root directory", "Moves to the previous directory", "Returns to the user's home directory", "Lists the current directory"],
answer: 2,
...
type: "mcq",
options: ["cd @mary", "cd ~mary", "cd $mary", "cd /mary"],
answer: 1,
...
type: "mcq",
options: ["Piping", "Tab completion", "Command grouping", "Variable expansion"],
answer: 1,
...
type: "mcq",
options: ["/home/root", "/root", "/usr/root", "/var/root"],
answer: 1,
...
type: "mcq",
options: ["/boot/efi", "/etc/efi", "/usr/efi", "/var/efi"],
answer: 0,
...
type: "mcq",
options: ["/usr/bin", "/usr/sbin", "/usr/lib", "/usr/src"],
answer: 0,
...
type: "mcq",
options: ["/usr/share", "/usr/sbin", "/usr/include", "/usr/local"],
answer: 1,
...
type: "mcq",
options: ["/var/log", "/var/lib", "/var/cache", "/run/log"],
answer: 0,
...
type: "mcq",
options: ["Allow variables to expand", "Treat text literally", "Run text in the background", "Create a pipeline"],
answer: 1,
...
type: "mcq",
options: ["Single quotes", "Double quotes", "Backslashes only", "Parentheses"],
answer: 1,
...
type: "mcq",
options: ["Display text on the terminal", "Create a directory", "Delete a file", "Search the filesystem"],
answer: 0,
...
type: "mcq",
options: ["It ends in `.hidden`", "It begins with a period", "It contains a dash", "It has no extension"],
answer: 1,
...
type: "mcq",
options: ["Hidden files", "Recursive output", "Human-readable file sizes", "Inode numbers"],
answer: 2,
...
type: "mcq",
options: ["Device", "Directory", "Data file", "Daemon"],
answer: 1,
...
type: "mcq",
options: ["Log file", "Library", "Symbolic link", "Local file"],
answer: 2,
...
type: "mcq",
options: ["Both directories are created automatically", "The command fails unless `-p` is used", "Only `42` is created", "The shell changes to `Projects`"],
answer: 1,
...
type: "mcq",
options: ["Only a source", "Only a destination", "A source and a destination", "A source and a pipe"],
answer: 2,
...
type: "mcq",
options: ["Yes", "No, `-R` is required", "Only with `-p`", "Only for empty directories"],
answer: 0,
...
type: "mcq",
options: ["Hard links share an inode; symbolic links do not", "Symbolic links share an inode; hard links do not", "Both always have different inodes", "Both always have the same inode"],
answer: 0,
...
type: "mcq",
options: ["They must share an inode with the original", "They can point across filesystems", "They duplicate the target's data", "They cannot become stale"],
answer: 1,
...
type: "mcq",
options: ["Only matching lines", "Lines that do not match the pattern", "Only line numbers", "A count of matches"],
answer: 1,
...
type: "mcq",
options: ["journalctl --follow", "tail --journal", "grep -f journal", "less --follow"],
answer: 0,
...
type: "mcq",
options: ["Shows every changed line", "Prints a simple message saying the files differ", "Creates an `ed` script", "Displays the files side by side"],
answer: 1,
...
type: "mcq",
options: ["User passwords", "Directories searched for command binaries", "Filesystem mount points", "Kernel parameters"],
answer: 1,
...
type: "mcq",
options: ["whereis", "which", "locate", "find"],
answer: 0,
...
type: "mcq",
options: ["find", "locate", "which", "stat"],
answer: 1,
...
type: "mcq",
options: ["It searches only `/home`", "Its database is typically refreshed only once per day", "It ignores text files", "It only searches mounted USB devices"],
answer: 1,
...
type: "mcq",
options: ["updatedb", "updated", "rebuilddb", "locate --update"],
answer: 0,
...
type: "mcq",
options: ["find", "which", "whereis", "cat"],
answer: 0,
...
type: "mcq",
options: ["The root directory", "The current working directory", "The user's home directory", "The `/tmp` directory"],
answer: 1,
...
type: "multi",
options: ["It has a single root directory `/`", "Different filesystems can be mounted at directories", "It combines storage devices into one virtual directory structure", "Every filesystem must have its own root directory exposed separately"],
answer: [0, 1, 2],
